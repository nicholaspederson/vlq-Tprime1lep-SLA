...
#echo "Singlet..."
#python -u dataCard.py bW0p5_tZ0p25_tH0p25 CR 100fbChi20p15FMnoPDF >& makecard_SgT_CR100fbChi20p15FM.log 
echo "bW..."
...
echo "bZ..."
python -u dataCard.py tW0p0_bZ1p0_bH0p0 CR 100fbChi20p15FM >& makecard_bH_CR100fbChi20p15FM.log 
#echo "Singlet..."
#python -u dataCard.py tW0p5_bZ0p25_bH0p25 CR 100fbChi20p15FMnoPDF >& makecard_SgB_CR100fbChi20p15FM.log 
echo "tW..."
...
echo "bZ..."
python -u dataCard.py tW0p0_bZ1p0_bH0p0 SRCR 100fb0p3smoothedL >& makecard_bH_SR100fb0p3smoothedL.log 
echo "Singlet..."
