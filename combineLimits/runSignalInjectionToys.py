...
if isSR and not os.path.exists(filename):
    ...
    masks = 'mask_TT_isSR_isE_notV01T1H_DeepAK8_0_2018=1,mask_TT_isSR_isE_notV01T2pH_DeepAK8_0_2018=1,mask_TT_isSR_isE_notV0T0H0Z01W_DeepAK8_0_2018=1,mask_TT_isSR_isE_notV0T0H0Z2pW_DeepAK8_0_2018=1,mask_TT_isSR_isE_notV0T0H1pZ_DeepAK8_0_2018=1,mask_TT_isSR_isE_notV1T0H_DeepAK8_0_2018=1,mask_TT_isSR_isE_notV2pT_DeepAK8_0_2018=1,mask_TT_isSR_isE_notVbW_DeepAK8_0_2018=1,mask_TT_isSR_isE_notVtH_DeepAK8_0_2018=1,mask_TT_isSR_isE_notVtZ_DeepAK8_0_2018=1,mask_TT_isSR_isE_taggedbWbW_DeepAK8_0_2018=1,mask_TT_isSR_isE_taggedtHbW_DeepAK8_0_2018=1,mask_TT_isSR_isE_taggedtZHtZH_DeepAK8_0_2018=1,mask_TT_isSR_isE_taggedtZbW_DeepAK8_0_2018=1,mask_TT_isSR_isM_notV01T1H_DeepAK8_0_2018=1,mask_TT_isSR_isM_notV01T2pH_DeepAK8_0_2018=1,mask_TT_isSR_isM_notV0T0H0Z01W_DeepAK8_0_2018=1,mask_TT_isSR_isM_notV0T0H0Z2pW_DeepAK8_0_2018=1,mask_TT_isSR_isM_notV0T0H1pZ_DeepAK8_0_2018=1,mask_TT_isSR_isM_notV1T0H_DeepAK8_0_2018=1,mask_TT_isSR_isM_notV2pT_DeepAK8_0_2018=1,mask_TT_isSR_isM_notVbW_DeepAK8_0_2018=1,mask_TT_isSR_isM_notVtH_DeepAK8_0_2018=1,mask_TT_isSR_isM_notVtZ_DeepAK8_0_2018=1,mask_TT_isSR_isM_taggedbWbW_DeepAK8_0_2018=1,mask_TT_isSR_isM_taggedtHbW_DeepAK8_0_2018=1,mask_TT_isSR_isM_taggedtZHtZH_DeepAK8_0_2018=1,mask_TT_isSR_isM_taggedtZbW_DeepAK8_0_2018=1'
    if 'tW' in BR: masks = masks.replace(',mask_TT_isSR_isE_taggedtZHtZH_DeepAK8_0_2018=1','').replace(',mask_TT_isSR_isM_taggedtZHtZH_DeepAK8_0_2018=1','').replace('bW','tW').replace('tZ','bZ').replace('tH','bH').replace('TT','BB')
