...
templateDir='/uscms_data/d3/escharni/CMSSW_10_2_10/src/singleLepAnalyzer/makeTemplates/templatesSR_July2019_With_Uncertainties'
...
if not os.path.exists('/uscms_data/d3/cholz/CMSSW_10_2_10/src/singleLepAnalyzer/thetaLimits/limitsJuly2019/'+templateDir.split('/')[-1]): os.system('mkdir /uscms_data/d3/cholz/CMSSW_10_2_10/src/singleLepAnalyzer/thetaLimits/limitsJuly2019/'+templateDir.split('/')[-1])
outputDir = '/uscms_data/d3/cholz/CMSSW_10_2_10/src/singleLepAnalyzer/thetaLimits/limitsJuly2019/'+templateDir.split('/')[-1]+'/'
limitType = 'comb1718'
...
def makeThetaConfig(rFile16,rFile17,rFile18,rFile2L16,rFile2L17,rFile2L18,rFile3L16,rFile3L17,rFile3L18,outDir,BRStr):
	rFileDir = rFile17.split('/')[-2]
	with open(outDir+'/'+rFileDir+'/'+rFile17.split('/')[-1][:-5]+'.py','w') as fout:
...
for file in rootfilelist:
    ...
    dict={'rundir':runDir,'configdir':outDir+fileDir,'configfile':file.split('/')[-1][:-5],'file1L17':file1L2017,'file1L18':file}
